...
#pragma warning disable CA1707, CA1401, CA1712
    ...
    public static class Methods
    {
        ...
        /// <returns>If the function succeeds, the return value is a handle to the compatible bitmap (DDB). If the function fails, the return value is <see cref="nint.Zero"/>.</returns>
